...
/* Dacă vrei ca headerul să fie transparent sus, schimbă în else -> remove */
function scrollHeader() {
   ...
   if (window.scrollY >= 50) {
      ...
      header.classList.add('header--blur'); // păstrăm blur mereu
   }
}
...
const iconTheme   = 'ri-sun-fill'; // când e dark, afișăm soarele ca să poți reveni pe light
...
/*  Galerie poze din pagina principală (index)*/
(function() {
